...
KERNEL_FQ void m90001_m04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
  ...
  for (u32 il_pos = 0; il_pos < IL_CNT; il_pos += VECT_SIZE)
  {
    ...
    m[ 0] = wordl0[0] | wordr0[0];
    m[ 1] = wordl0[1] | wordr0[1];
    m[ 2] = wordl0[2] | wordr0[2];
    m[ 3] = wordl0[3] | wordr0[3];
    m[ 4] = wordl1[0] | wordr1[0];
    m[ 5] = wordl1[1] | wordr1[1];
    m[ 6] = wordl1[2] | wordr1[2];
    m[ 7] = wordl1[3] | wordr1[3];
    m[ 8] = wordl2[0] | wordr2[0];
    m[ 9] = wordl2[1] | wordr2[1];
    m[10] = wordl2[2] | wordr2[2];
    m[11] = wordl2[3] | wordr2[3];
    m[12] = wordl3[0] | wordr3[0];
    m[13] = wordl3[1] | wordr3[1];
    m[14] = wordl3[2] | wordr3[2];
    m[15] = wordl3[3] | wordr3[3];
    m[16] = 0;
    m[17] = 0;
    m[18] = 0;
    m[19] = 0;
    ...
    switch_buffer_by_offset_8x4_le_VV (s0, s1, s2, s3, s4, s5, s6, s7, pw_len);
...
KERNEL_FQ void m90001_m08 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ void m90001_m16 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ void m90001_s04 (KERN_ATTR_BASIC ())
{
  /**
   * base
   */
...
KERNEL_FQ void m90001_s08 (KERN_ATTR_BASIC ())
{
}

KERNEL_FQ void m90001_s16 (KERN_ATTR_BASIC ())
{
}
